<%@ Page Title="QuickContacts" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false"
    CodeFile="ContactsView.aspx.vb" Inherits="ContactsView" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        El control <code>ContactsView</code> permite almacenar una lista de contactos en una libreta de direcciones. 
    ...
    <h4>Ejemplo</h4>
    <hr />
    <wc:ContactsView ID="ContactsView" runat="server" BorderStyle="Solid" BorderWidth="1px">
    ...
    <hr />
    <pre class="prettyprint linenums">&lt;cc2:ContactsView ID=&quot;ContactsView&quot; runat=&quot;server&quot; BorderStyle=&quot;Solid&quot; BorderWidth=&quot;1px&quot;&gt;
